  ...
  return (
      ...
      <div className="home__section">
        <div className="home__content" data-aos="fade-right">
          <h1>¿Quieres enviar dinero a tu familia desde America?</h1>
          <p>
      ...
      <div className="horizontal-section">
        <div className="horizontal-section__item" data-aos="fade-up">
          ...
          />
          <h3>Enviar dinero desde America</h3>
          <p>
            Envía dinero desde toda America y recíbelo en minutos. Recibe en
